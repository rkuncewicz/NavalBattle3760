...
//        }
        ...
        if (game.shipSelected == false){
            ...
            //Time of day settings, implemented
            if (time == 0) {
    ...
    public void buildRocks()
    {
        int x = 0, y = 0;
        rocks.clear();
      //  int ship_x = game.shiplist.get(0).relativeXco;
     //   int ship_y = game.shiplist.get(0).relativeYco;
...
//        g.drawImage(ocean_rock, 300, 200, null);
//        g.drawImage(ocean_rock, 600, 60, null);
//        g.drawImage(ocean_rock, 650, 240, null);
    }
